...
const LocationPage = () => {
  ...
  // Destructuring will work once the Provider is in App.jsx
  const { savedLocations, toggleSave } = useSaved();
  
  const location = MOCK_LOCATIONS.find(loc => loc.id === Number(id)) || MOCK_LOCATIONS[0];

  // Safety check: if savedLocations is still undefined for a split second
      ...
      <div className="location-page">
        ...
        <div className="location-image-container">
          <img
            ...
            onClick={toggleExpand} // Click to open
          ...
          >
            ...
            <svg
              ...
              height="20"
              viewBox="0 0 24 24"
              fill={isLiked ? "white" : "none"} // Fills when liked
              stroke="currentColor"
              strokeWidth="2"
              strokeLinecap="round"
